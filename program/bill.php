            ...
            <div id="table">
                <table>
                    ...
                    ?>
                        <tr class="service">
                            <td class="tableitem">
                                <p class="itemtext"><?php echo $item["pname"] ?></p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext"><?php echo $item["quantity"] ?></p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext"><?php echo $item["pprice"] ?></p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext"><?php echo $item_price ?></p>
                            </td>
                        </tr>
