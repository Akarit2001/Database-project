...
if (isset($_POST["addAmount"]) && isset($_POST["apid"])) {
    $apid = $_POST["apid"];
    $apamount = $_POST["addAmount"];
                ...
                <div class="profile-content">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" name="adm">
                        <fieldset>
                            ...
                            <label for="addAmount">Amout: </label>
                            <input id="addAmount" type="number" min="1" placeholder="จำนวนสินค้าที่ต้องการเพิ่ม" name="addAmount" required>
                        </fieldset>
                        <div class="div_btn">
